...
public class Test {
	...
	public static void main(String[] args) {
		...
		int[] array32 = new int[BLOCK_SIZE / 4], array32_2 = new int[10000], ini = {
		...
		for (int i = 0; i < 10000; i++) {
			if (i < 1000) {
				System.out.print(String.format("%10d ", (long) array32[i]
						& (-1L >>> 32)));
				if (i % 5 == 4)
					System.out.println();
			}
			...
			if (r32 != array32[i])
				throw new RuntimeException(
						String.format("mismatch at %d array32:%x next:%x", i,
								array32[i], r32));
		}
		for (int i = 0; i < 700; i++) {
			int r32 = sfmt.next();
